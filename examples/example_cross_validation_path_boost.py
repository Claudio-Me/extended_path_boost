...
from path_boost.utils.datasets_for_examples.generate_example_dataset import (
    generate_synthetic_graph_dataset,
)
...
if __name__ == "__main__":
    ...
    grid_search = GridSearchCV(
        estimator=path_boost, param_grid=param_grid, cv=2, scoring=score, verbose=3
    )
    ...
    grid_search.fit(
        X_train,
        y_train,
        list_anchor_nodes_labels=anchor_types_for_generation_and_boosting,
